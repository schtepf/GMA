...
%% vectors and matrices with tilde in discriminant space
\newcommand{\tvm}[1][]{\Vector[#1]{\tilde{m}}} 
...
%% \mathbf{D} = \Diag{\lambda_1, \ldots, \lambda_d} ... diagonal matrix
...
%% \Norm[2]{\vx} ... vector and matrix norm
\newcommand{\Norm}[2][]{\left\| #2 \right\|_{#1}}
\newcommand{\bigNorm}[2][]{\bigl\| #2 \bigr\|_{#1}}

%% \llh ... Lawley-Hotelling trace as MANOVA criterion
\newcommand{\llh}{\lambda_{\text{LH}}}
